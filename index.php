                        ...
                        <div class="row pt-115">
                            ...
                            <div class="col-lg-6">
                                <div class="inner-content-about">
                                    <h2 class="title-heading mb-18 fadeInUp wow">About<span
                                    ...
                                    <div class="map-check flex-three fadeInUp wow mt-4">
                                        ...
                                        <span class="text-main">Checkout Beautiful Places Arround the Guhagar.</span>
                                    </div>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="new-york-tab-pane" role="tabpanel"
                                            ...
                                            <div class="client_main_block">
                                                <div class="container-fluid">
                                                <div class="container-fluid">
                                                    <div class="cs-isotop cs-style1 cs-isotop_col_4 cs-has_gutter_24 cs-lightgallery" style="position: relative; height: 1292px;">
                                                        <div class="cs-grid_sizer"></div>
                                                            <div class="static-thumbnails-lightgallery">
                                                                ...
                                                                <a href="./assets/images/gallery/ac-rooms/img2.webp" class="content-grid cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2 cs-isotop_item top-3">
                                                                    <div class="cs-portfolio_hover"></div>
                                                                    <span class="cs-plus"></span>
                                                                    <div class="cs-portfolio_bg cs-bg" data-src="./assets/images/gallery/ac-rooms/img2.webp" style="background-image: url(&quot;./assets/images/gallery/ac-rooms/img2.webp&quot;);"></div>
                                                                    <div class="cs-portfolio_info">
                                                                ...
                                                                <a href="./assets/images/gallery/ac-rooms/img2.webp" class="content-grid cs-portfolio cs-style1 cs-lightbox_item cs-size2 cs-type2 cs-isotop_item top-4">
                                                                    <div class="cs-portfolio_hover"></div>
                                                                    <span class="cs-plus"></span>
                                                                    <div class="cs-portfolio_bg cs-bg" data-src="./assets/images/gallery/ac-rooms/img2.webp" style="background-image: url(&quot;./assets/images/gallery/ac-rooms/img2.webp&quot;);"></div>
                                                                    <div class="cs-portfolio_info">
                                                                ...
                                                                <a href="./assets/images/gallery/ac-rooms/img1.webp" class="content-grid cs-portfolio cs-style1 cs-lightbox_item cs-size1 cs-type2 cs-isotop_item top-5">
                                                                    <div class="cs-portfolio_hover"></div>
                                                                    <span class="cs-plus"></span>
                                                                    <div class="cs-portfolio_bg cs-bg" data-src="./assets/images/gallery/ac-rooms/img1.webp" style="background-image: url(&quot;./assets/images/gallery/ac-rooms/img1.webp&quot;);"></div>
                                                                    <div class="cs-portfolio_info">
                                                                ...
                                                                <a href="./assets/images/gallery/ac-rooms/img1.webp" class="content-grid cs-portfolio cs-style1 cs-lightbox_item cs-size1 cs-type2 cs-isotop_item top-6">
                                                                    <div class="cs-portfolio_hover"></div>
                                                                    <span class="cs-plus"></span>
                                                                    <div class="cs-portfolio_bg cs-bg" data-src="./assets/images/gallery/ac-rooms/img1.webp" style="background-image: url(&quot;./assets/images/gallery/ac-rooms/img1.webp&quot;);"></div>
                                                                    <div class="cs-portfolio_info">
                    ...
                    <div class="tf-container">
                        <div class="row z-index3 relative">
                            <div class="col-lg-12 mb-60">
                                <div class="clip-text">Sightseeing</div>
                            </div>
                            <div class="col-lg-12">
                                <ul class="nav nav-tabs-activities justify-content-center" id="myTablist"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                            ...
                                            <span>Guhagar Beach & Water Sports</span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                            ...
                                            <span>Velneshwar Seashore & Temple</span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                            ...
                                            <span>Crocodile Safari, Paruchuri</span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="ab-tab" data-bs-toggle="tab"
                                            ...
                                            <span>Bird watching, Abloli</span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
